...
def compose_prompt(
    ...
    if raw_prompt_override:
        final_prompt = _compose_raw_override_prompt(raw_prompt_override, prompt_plan)
        prompt_visible_copy_slots = []
    else:
        final_prompt, prompt_visible_copy_slots = format_prompt_blocks(
            blocks,
    ...
    return {
        ...
        "visible_copy_slots": prompt_visible_copy_slots,
